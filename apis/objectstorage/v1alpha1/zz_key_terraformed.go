...
func (tr *Key) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_key": "status.atProvider.accessKey", "regions_details[*]": "status.atProvider.regionsDetails[*]", "secret_key": "status.atProvider.secretKey"}
}
